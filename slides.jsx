        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 8 }}>
            ...
            <div style={{
              ...
              <img src="assets/bounce-rate.png" alt="Google Analytics overview — 83.68% bounce rate magnified" style={{ width: '100%', height: 'auto', display: 'block' }} />
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 56, display: 'grid', gridTemplateColumns: '1fr 1fr 0.6fr', gap: 24, alignItems: 'end' }}>
        {[
          { src: 'assets/homepage-early-concept.png', label: 'Concept exploration', kind: 'desktop' },
          { src: 'assets/homepage-desktop.png', label: 'Final hub design', kind: 'desktop' },
          { src: 'assets/homepage-mobile.png', label: 'Mobile hub', kind: 'mobile' },
        ].map((a) => (
